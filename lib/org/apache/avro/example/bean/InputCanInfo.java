...
public class InputCanInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public org.apache.avro.example.bean.CanData canData;
   ...
   */
  public InputCanInfo(java.lang.CharSequence canId, java.lang.Long canTime, org.apache.avro.example.bean.CanData canData) {
    this.canId = canId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: canData = (org.apache.avro.example.bean.CanData)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public org.apache.avro.example.bean.CanData getCanData() {
    return canData;
  }
   ...
   * @param value the value to set.
   */
  public void setCanData(org.apache.avro.example.bean.CanData value) {
    this.canData = value;
  }
   ...
   */
  public static org.apache.avro.example.bean.InputCanInfo.Builder newBuilder() {
    return new org.apache.avro.example.bean.InputCanInfo.Builder();
  }
   ...
   * @return A new InputCanInfo RecordBuilder
   */
  public static org.apache.avro.example.bean.InputCanInfo.Builder newBuilder(org.apache.avro.example.bean.InputCanInfo.Builder other) {
    return new org.apache.avro.example.bean.InputCanInfo.Builder(other);
  }
   ...
   * @return A new InputCanInfo RecordBuilder
   */
  public static org.apache.avro.example.bean.InputCanInfo.Builder newBuilder(org.apache.avro.example.bean.InputCanInfo other) {
    return new org.apache.avro.example.bean.InputCanInfo.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InputCanInfo>
    ...
    private org.apache.avro.example.bean.CanData canData;
    private org.apache.avro.example.bean.CanData.Builder canDataBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.apache.avro.example.bean.InputCanInfo.Builder other) {
      super(other);
      ...
      if (other.hasCanDataBuilder()) {
        this.canDataBuilder = org.apache.avro.example.bean.CanData.newBuilder(other.getCanDataBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.apache.avro.example.bean.InputCanInfo other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.canId)) {
        this.canId = data().deepCopy(fields()[0].schema(), other.canId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder setCanId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder clearCanId() {
      canId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder setCanTime(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder clearCanTime() {
      canTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder setCanData(org.apache.avro.example.bean.CanData value) {
     ...
     * @return This builder.
     */
    public org.apache.avro.example.bean.CanData.Builder getCanDataBuilder() {
      if (canDataBuilder == null) {
        if (hasCanData()) {
          setCanDataBuilder(org.apache.avro.example.bean.CanData.newBuilder(canData));
        } else {
          setCanDataBuilder(org.apache.avro.example.bean.CanData.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public org.apache.avro.example.bean.InputCanInfo.Builder setCanDataBuilder(org.apache.avro.example.bean.CanData.Builder value) {
      clearCanData();
    ...
    /**
      ...
      * @return This builder.
      */
    public org.apache.avro.example.bean.InputCanInfo.Builder clearCanData() {
      canData = null;
      canDataBuilder = null;
    ...
    public InputCanInfo build() {
      try {
        ...
        if (canDataBuilder != null) {
          ...
          record.canData = fieldSetFlags()[2] ? this.canData : (org.apache.avro.example.bean.CanData) defaultValue(fields()[2]);
        }
        return record;
