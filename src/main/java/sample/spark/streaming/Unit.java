...
public class Unit {
    public static CanInfoBean createCanUnitBean(short id, String canTime) {
        CanInfoBean bean = new CanInfoBean();
        bean.setCanId(id);
    ...
    public static CanInfoBean createCanUnitBeanNull(short id, String canTime) {
        CanInfoBean bean = new CanInfoBean();
        bean.setCanId(id);
        bean.setCanTime(Long.parseLong(canTime));
        Map<String, Object> values = new HashMap<>();
    ...
    public static CanInfoBean createCanUnitBean2(short id, String canTime) {
        CanInfoBean bean = new CanInfoBean();
        bean.setCanId(id);
        bean.setCanTime(Long.parseLong(canTime));
        Map<String, Object> values = new HashMap<>();
    ...
    public static CanInfoBean createRadomCanUnitBean(short id, String canTime) {
        CanInfoBean bean = new CanInfoBean();
        bean.setCanId(id);
        bean.setCanTime(Long.parseLong(canTime));
        Map<String, Object> values = new HashMap<>();
    ...
    public static void converedCanUnitBean(CanInfoBean bean, CanInfoBean subcan) {
    ...
    public static void converedCanUnitBeanOf0X22(CanInfoBean bean, CanInfoBean subcan) {
