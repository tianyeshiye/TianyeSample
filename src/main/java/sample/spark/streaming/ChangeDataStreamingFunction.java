...
public class ChangeDataStreamingFunction implements
        PairFlatMapFunction<Iterator<Tuple2<TelegramInfoHash, List<CanInfoBean>>>, TelegramInfoHash, List<CanInfoBean>> {

    public Iterator<Tuple2<TelegramInfoHash, List<CanInfoBean>>> call(
            final Iterator<Tuple2<TelegramInfoHash, List<CanInfoBean>>> tuples) throws Exception {

        return new Iterator<Tuple2<TelegramInfoHash, List<CanInfoBean>>>() {

            private List<CanInfoBean> changedCanUnitBeanList;

            private TelegramInfoHash progress;

            private HashMap<Long, CanInfoBean> subCanHashMap = new HashMap<Long, CanInfoBean>();
            ...
            private void ensureNexrElement() {
                ...
                while (tuples.hasNext()) {
                    ...
                    final Tuple2<TelegramInfoHash, List<CanInfoBean>> tuple = tuples.next();
            ...
            public Tuple2<TelegramInfoHash, List<CanInfoBean>> next() {
                ...
                this.subCanHashMap = new HashMap<Long, CanInfoBean>();
            ...
            // convert 0x22 以外
            private void convertDataOfCommonCan(List<CanInfoBean> canUnitBeanList) {

                for (CanInfoBean canUnitBean : canUnitBeanList) {
            ...
            // convert 0x22
            private void convertDataOf0X22(List<CanInfoBean> canUnitBeanList) {
