...
public class CanInfoBean implements Serializable , KryoSerializable{
	...
	public boolean  compareToTimeInterval(CanInfoBean other, int timmeInterval) {
...
//System.out.println("888---" + tmStampThis + ":" + tmStampOther);
	...
	public  CanInfoBean(CanInfoBean clone) {
