...
public class C022 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static sample.avro.bean.C022.Builder newBuilder() {
    return new sample.avro.bean.C022.Builder();
  }
   ...
   * @return A new C022 RecordBuilder
   */
  public static sample.avro.bean.C022.Builder newBuilder(sample.avro.bean.C022.Builder other) {
    return new sample.avro.bean.C022.Builder(other);
  }
   ...
   * @return A new C022 RecordBuilder
   */
  public static sample.avro.bean.C022.Builder newBuilder(sample.avro.bean.C022 other) {
    return new sample.avro.bean.C022.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<C022>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(sample.avro.bean.C022.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(sample.avro.bean.C022 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.c022_dummy15)) {
        this.c022_dummy15 = data().deepCopy(fields()[0].schema(), other.c022_dummy15);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder setC022Dummy15(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder clearC022Dummy15() {
      c022_dummy15 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder setC022Dummy16(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder clearC022Dummy16() {
      c022_dummy16 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder setC022Dummy17(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder clearC022Dummy17() {
      c022_dummy17 = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder setC022Dummy18(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sample.avro.bean.C022.Builder clearC022Dummy18() {
      c022_dummy18 = null;
